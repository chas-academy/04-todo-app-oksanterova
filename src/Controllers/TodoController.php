...
class TodoController extends Controller {
    ...
    public function get()
    {
        ...
        return $this->view('index', ['todos' => $todos, 'filter' => 'all']);
    }

    public function filterCompleted()
    {
      $completed = 1;
      $todos = TodoItem::filter($completed);

      return $this->view('index', ['todos' => $todos, 'filter' => 'completed']);
    }
    ...
    public function filterActive()
    {
      ...
      return $this->view('index', ['todos' => $todos, 'filter' => 'active']);
    }
